...
| 序号 | 内容 | 重点 | 文档 | 状态 |
|-----|------|------|------|------|
| 8 | 日志、状态查看、问题排查 | openclaw logs、doctor | 官方运维文档 | ✅ 已掌握 |
| 9 | 启动、停止、状态检查 | gateway 命令 | 官方 Gateway 文档 | ✅ 已掌握 |
...
| 序号 | 内容 | 目标 | 状态 |
|-----|------|------|------|
| 10 | 从零搭建 | 在新机器上完整配置 OpenClaw | ✅ 已掌握 |
| 11 | 自定义 Skill | 开发一个自己的 skill | ✅ 已掌握 |
| 12 | 长期记忆集成 | 配置 memU 实现主动记忆 | ✅ 已掌握 |
